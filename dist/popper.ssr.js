...
function requireDebounce () {
	...
	debounce_1 = debounce;
	return debounce_1;
}var debounceExports = requireDebounce();function useEventListener(target, event, handler) {
  if (vue.isRef(target)) {
  ...
  vue.onBeforeUnmount(function () {
    var _unref;
    (_unref = vue.unref(target)) === null || _unref === void 0 || _unref.removeEventListener(event, handler);
  });
...
function usePopper(_ref) {
  ...
  var setPopperEventListeners = function setPopperEventListeners(enabled) {
    ...
    (_state$popperInstance = state.popperInstance) === null || _state$popperInstance === void 0 || _state$popperInstance.setOptions(function (options) {
...
script$1.__scopeId = "data-v-20b7fd4a";var script = {
  __name: 'Popper',
  props: {
    /**
  ...
  setup: function setup(__props, _ref) {
    ...
    var openPopperDebounce = debounceExports.debounce(open, openDelay.value);
    var closePopperDebounce = debounceExports.debounce(close, closeDelay.value);
    ...
    vue.watch(isOpen, function (isOpen) {
      if (isOpen) {
        ...
        debounceExports.debounce(function () {
    ...
    return function (_ctx, _cache) {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: "inline-block",
        style: vue.normalizeStyle(interactiveStyle.value),
        ...
        default: vue.withCtx(function () {
          ...
          }), __props.arrow ? (vue.openBlock(), vue.createBlock(script$1, {
            key: 0
          })) : vue.createCommentVNode("", true)], 512), [[vue.vShow, shouldShowPopper.value]])];
        }),
        _: 3
      })], 36);
    };
...
styleInject(css_248z);script.__scopeId = "data-v-5784ed69";// Default export is installable instance of component.
