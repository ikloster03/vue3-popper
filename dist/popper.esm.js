...
function useEventListener(target, event, handler) {
  ...
  onBeforeUnmount(() => {
    var _unref;
    (_unref = unref(target)) === null || _unref === void 0 || _unref.removeEventListener(event, handler);
  });
}
...
var script = {
  ...
  setup(__props, {
    ...
    const openPopperDebounce = debounceExports.debounce(open, openDelay.value);
    const closePopperDebounce = debounceExports.debounce(close, closeDelay.value);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: "inline-block",
        style: normalizeStyle(interactiveStyle.value),
        ...
        }, () => [createTextVNode(toDisplayString(unref(content)), 1)]), __props.arrow ? (openBlock(), createBlock(script$1, {
          key: 0
        })) : createCommentVNode("", true)], 512), [[vShow, shouldShowPopper.value]])]),
        _: 3
      })], 36);
    };
  }
